...
import com.zhangbaowei.callgo.LibGoRedis;
...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        RpcRedis redis = new RpcRedis("localhost:7777");
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Thread thread = new Thread(() -> {
                ...
                Map<String, String> all = redis.getAll(collect);

                System.out.println(finalI + ":" + serializeToString(all));
